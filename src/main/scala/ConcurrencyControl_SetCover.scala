...
/**
 * Class implementing CC-2g set cover as a separable group sum objective function.
 ...
 */
class ConcurrencyControl_SetCover(nElements: Int, nGroups: Int, graph: SparseGraph, lambda: Double)
  extends ConcurrencyControl_SeparableGroupSums(nElements, nGroups, graph, lambda){
